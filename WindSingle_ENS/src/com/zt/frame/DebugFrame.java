...
import com.zt.panel.Debug.MutationGivenPanel;
...
public class DebugFrame extends JFrame {
	...
	public JTabbedPane buildJTabbedPane(){
		  ...
		  MutationGivenPanel mutationGivenPanel = new MutationGivenPanel(this.getWidth(),this.getHeight());
		  statePanel = new StatePanel(this.getWidth(),this.getHeight());
		  controlPanel = new ControlPanel(this.getWidth(),this.getHeight());
		  tab.add(mutationGivenPanel,"参数设定");
