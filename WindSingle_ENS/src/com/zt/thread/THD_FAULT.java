...
public class THD_FAULT extends Thread {
	...
	public void analysisState(String[] values,List<ModbusBit> lBits,List<Object> objects){
		...
		if(actionCommand==null){
			if(dFrame.getName().equals("A相故障")) actionCommand="74";
			if(dFrame.getName().equals("B相故障")) actionCommand="134";
			if(dFrame.getName().equals("C相故障")) actionCommand="194";
		}
...
//			}
		...
		for(int i=0;i<vLists.size();i++){
			...
			if(list.size()!=0&&actionCommand.equals(list.get(1))){
