...
//				System.out.println(sMessageParam.getName()+" "+sMessageParam.getAddr());
	...
	public void dataApps(String dataStr) {
		...
		time1 = dataArray[57] + "-" + dataArray[58] + "-" + dataArray[59];
		time2 = dataArray[60] + ":" + dataArray[61] + ":" + dataArray[62];
		for(String key:maps.keySet()){
			List<ModbusApp> modbusApps = maps.get(key);
			for (ModbusApp modbusApp : modbusApps) {
