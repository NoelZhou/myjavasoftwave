...
public class SaveMessage {
	...
	private List<String> paramsForRecordModel =  new ArrayList<>();
	...
	public List<String> getParamsForRecordModel() {
		return paramsForRecordModel;
	}
	public void setParamsForRecordModel(List<String> paramsForRecordModel) {
		this.paramsForRecordModel = paramsForRecordModel;
	}
