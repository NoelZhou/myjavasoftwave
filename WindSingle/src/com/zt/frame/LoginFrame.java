...
//	private JComboBox<String> comboBox;
	...
	public LoginFrame() {
		...
		textField.setBounds(106, 33, 140, 21);
...
//				tOne.setModbusTcp(comboBox.getSelectedIndex());
				tOne.setModbusTcp(0);
		...
		/*JLabel label_1 = new JLabel("机型：");
		label_1.setBounds(26, 96, 54, 15);
		contentPane.add(label_1);
		comboBox = new JComboBox<String>();
		comboBox.setModel(new DefaultComboBoxModel<String>(new String[] { "双馈", "全功率", "海上风电" }));
		comboBox.setBounds(64, 93, 80, 21);
